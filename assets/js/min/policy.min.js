...
document.addEventListener("DOMContentLoaded",function(){if(window.innerWidth>768){const e=document.querySelectorAll(".footer-links li, .burger-lines-wrap, .menu_open-social"),n=new MouseFollower({container:"body",speed:.55});e.forEach(function(e){e.addEventListener("mouseenter",()=>{n.addState("-inverse-scaled")}),e.addEventListener("mouseleave",()=>{n.removeState("-inverse-scaled")})})}});

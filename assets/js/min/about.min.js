...
document.addEventListener("DOMContentLoaded",function(){const e=window.innerWidth;let t,n,o;e>768?(t=3.5,n=4,o=60):(t=1.6,n=1,o=20);const s=document.querySelector(".first_top_cube"),i=document.querySelector(".first_bot_cube"),r={inputElement:document.getElementById("first"),hoverOnly:!0,invertX:!1,invertY:!1,limitX:50,limitY:50};new Parallax(s,r),new Parallax(i,r),new Swiper(".about_slider",{slidesPerView:t,slidesPerGroup:n,spaceBetween:o,loop:!1,on:{slideChange:function(){e>450&&(this.isEnd?this.el.classList.add("reach_end"):this.el.classList.remove("reach_end"))},reachEnd:function(){e<769&&e<450&&this.el.classList.add("reach_end")}}});function l(e,t){e.forEach(function(e){e.addEventListener("mouseenter",()=>{a.addState(t)}),e.addEventListener("mouseleave",()=>{a.removeState(t)})})}const d=document.querySelectorAll(".footer-links li, .burger-lines-wrap, .menu_open-social"),c=document.querySelectorAll(".members_soc_item");l(d,"-inverse-scaled"),l(c,"-small-inverse-scaled");const a=new MouseFollower({container:"body",speed:.55})});

...
document.addEventListener("DOMContentLoaded",function(){const e=window.innerWidth,t=e>768;let n,o,s;t?(n=3.5,o=4,s=60):(n=1.6,o=1,s=20);const i=document.querySelector(".first_top_cube"),r=document.querySelector(".first_bot_cube"),l={inputElement:document.getElementById("first"),hoverOnly:!0,invertX:!1,invertY:!1,limitX:50,limitY:50};new Parallax(i,l),new Parallax(r,l),new Swiper(".about_slider",{slidesPerView:n,slidesPerGroup:o,spaceBetween:s,loop:!1,on:{slideChange:function(){e>450&&(this.isEnd?this.el.classList.add("reach_end"):this.el.classList.remove("reach_end"))},reachEnd:function(){e<769&&e<450&&this.el.classList.add("reach_end")}}});if(t){function d(e,t){e.forEach(function(e){e.addEventListener("mouseenter",()=>{n.addState(t)}),e.addEventListener("mouseleave",()=>{n.removeState(t)})})}const e=document.querySelectorAll(".footer-links li, .burger-lines-wrap, .menu_open-social"),t=document.querySelectorAll(".members_soc_item");d(e,"-inverse-scaled"),d(t,"-small-inverse-scaled");const n=new MouseFollower({container:"body",speed:.55})}});

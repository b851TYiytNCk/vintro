...
document.addEventListener("DOMContentLoaded",function(){const e=window.innerWidth,t=document.querySelector(".btn-submit"),n=document.querySelector(".tg_link");if(e>768){const e=new MouseFollower({container:"body",speed:.55});const s=document.querySelectorAll(".footer-links li, .burger-lines-wrap, .menu_open-social");function i(t){t.addEventListener("mouseenter",()=>{e.hide()}),t.addEventListener("mouseleave",()=>{e.show()})}o="-inverse-scaled",s.forEach(function(t){t.addEventListener("mouseenter",()=>{e.addState(o)}),t.addEventListener("mouseleave",()=>{e.removeState(o)})}),i(t),i(n)}var o;const s=document.querySelector(".name_input"),c=document.querySelector(".email_input"),a=document.querySelector(".text_input"),r=document.querySelector(".last-row-br");function l(e,t){let n=e,i=window.getSelection(),o=document.createRange();e.addEventListener("click",function(e){e.target.classList.contains("active")||(o.setStart(n,0),o.setEnd(n,0),i.removeAllRanges(),i.addRange(o))}),e.addEventListener("focusout",function(e){const n=e.target;n.innerHTML.length<1&&(n.style.color="#d8d8d8",n.innerHTML=t,n.classList.remove("active"),n.classList.contains("text_input")&&(r.style.display="inline"))}),e.addEventListener("keyup",function(e){const t=e.target;t.classList.contains("active")||(t.style.color="transparent",t.innerText=t.innerText.slice(0,1),o.setStart(n,1),o.setEnd(n,1),i.removeAllRanges(),i.addRange(o),t.classList.contains("text_input")&&(r.style.display="none"),t.classList.add("active"))})}l(s,"Rudolf"),l(c,"r@email.com"),l(a,"the new website development for my company");const d=document.querySelector(".span-br");s.addEventListener("input",function(t){let n;e>1800?n=212:e>1366?n=212:e>1023&&(n=154);const i=t.target.offsetWidth;a.offsetWidth;e>768&&(i>n?(d.style.display="none",r.style.display="none"):d.style.display="inline")});const u=document.querySelector(".hello"),y=document.querySelector(".feedback_main");function m(e){if(e.innerHTML.length>1&&e.classList.contains("active"))return!0}function f(e){if(e.innerHTML.length>5&&e.innerHTML.includes("@")&&e.classList.contains("active"))return!0}function p(e){if(e.innerHTML.length>5&&e.classList.contains("active"))return!0}t.addEventListener("click",function(){const e=s,t=c,n=a,i=document.querySelector(".contact_notice_wrap"),o=document.querySelector(".contact_notice_text--name"),r=document.querySelector(".contact_notice_text--email"),l=document.querySelector(".contact_notice_text--subj"),d=document.querySelectorAll(".contact_notice_text");i.classList.remove("active"),setTimeout(()=>{d.forEach(e=>{e.style.display="none"})},1e3),m(e)&&f(t)&&p(n)?async function(e="",t={}){const n=await fetch(e,{method:"POST",mode:"cors",cache:"no-cache",credentials:"same-origin",headers:{"Content-Type":"application/json"},redirect:"follow",referrerPolicy:"no-referrer",body:JSON.stringify(t)});return await n.json()}("/send.php",{name:e.innerText,email:t.innerText,text:n.innerText}).then(e=>{if(console.log(e),e.error)switch(e.error){case"all":[o,l,r].forEach(e=>{e.style.display="inline"});break;case"name_email":[o,r].forEach(e=>{e.style.display="inline"});break;case"name_text":[o,l].forEach(e=>{e.style.display="inline"});break;case"email_text":[l,r].forEach(e=>{e.style.display="inline"})}else{const e=document.querySelector(".contact_input.name_input.active").innerHTML;document.querySelector("#hello_name").innerHTML=e,function(e,t){e.classList.add("transparent"),setTimeout(()=>{e.style.display="none",t.style.display="block",setTimeout(()=>{t.classList.remove("transparent")},5)},500)}(y,u)}}):setTimeout(()=>{m(e)||(o.style.display="inline"),p(n)||(l.style.display="inline"),f(t)||(r.style.display="inline"),i.classList.add("active")},1e3)})});
